...
RUN sed -i "s/pid =.*/pid = \/var\/run\/php7.1-fpm.pid/" /etc/php/7.1/fpm/php-fpm.conf
RUN sed -i "s/error_log =.*/error_log = \/var\/log\/php_error.log/" /etc/php/7.1/fpm/php-fpm.conf
